        ...
        try {
            DB::transaction(function () {
                ...
                $team = Team::create([
                    'name' => $this->name,
                    'user_id' => Auth::id(),
                    'personal_team' => false, // Default value, modify as needed
                ]);
            ...
            // Emit success message and redirect or handle further actions
...
<div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 relative">
        ...
        <form wire:submit.prevent="createTeam" class="mt-6">
            <div class="mb-6">
                <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Team
                    Name</label>
