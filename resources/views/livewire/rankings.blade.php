...
<div class="container p-4 mx-auto sm:p-4 lg:p-6">
    <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-2xl overflow-hidden">
        ...
        <!-- Rankings List with Enhanced Cards -->
        <div class="divide-y divide-gray-700/30">
            ...
            @else
                @foreach ($teamRankings as $index => $user)
                    <div class="group relative transition-all duration-200 hover:bg-gray-800/50">
                        <div class="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-transparent group-hover:from-blue-600/5 group-hover:via-purple-600/5 group-hover:to-transparent transition-all duration-300"></div>
                        <div class="relative flex items-center px-6 py-4 space-x-4">
                            <!-- Rank Number with Special Styling for Top 3 -->
                            <div class="flex-shrink-0 w-12 text-center">
                                @if ($index < 3)
                                    <span class="inline-flex items-center justify-center w-10 h-10 rounded-lg transform transition-transform group-hover:scale-110
                                ...
                                @else
                                    <span class="font-medium text-gray-400 text-lg">
                                        {{ $index + 1 }}
                                    </span>
                                @endif
                            </div>
                            ...
                            <div class="flex-grow">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <div class="flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 transform transition-transform group-hover:scale-105">
                                    ...
                                    <div class="ml-4">
                                        <h2 class="text-lg font-bold text-white group-hover:text-blue-400 transition-colors duration-200">
                                            {{ $user->name }}
                                        </h2>
                            ...
                            <div class="flex-shrink-0">
                                <span class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold
                                    ...
                                    transform transition-all duration-200 group-hover:scale-105 group-hover:shadow-lg">
                                    Rank #{{ $user->rank }}
                                </span>
                            </div>
                        </div>
    ...
    <div class="flex justify-end mt-6">
        <button wire:click="loadTeamRankings" 
                ...
                class="inline-flex items-center px-6 py-3 text-sm font-semibold text-white 
                       bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg
                       transition-all duration-200 hover:shadow-lg hover:from-blue-700 hover:to-purple-700
