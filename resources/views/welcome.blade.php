            ...
            <div class="md:flex md:items-center md:justify-between">
                ...
                <div class="mt-8 md:order-1 md:mt-0">
                    <p class="text-base text-center text-gray-400">
                        ...
                        <!-- Signature -->
                        <div class="mt-4 text-sm text-center text-gray-400 text-muted">
                            <p>Designed and developed with care by <a href="https://kgl-ramzii.fly.dev" target="_blank"
                                    class="font-semibold text-cyan-500 hover:text-orange-400">Kagiso Ramogayana</a>.</p>
                        </div>
